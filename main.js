...
var ASPECT, FAR, HEIGHT, NEAR, T, VIEW_ANGLE, WIDTH, animate, camera, canvas, canvases, controls, ctx, dimensions, faceMaterial, groundMirror, i, light, map, materials, mirrorMesh, mouse, planeGeom, product, productGeometry, renderer, scene, skyBox, skyBoxGeometry, skyBoxMaterial, unprojector;
...
$('input').each(function(i) {
  return $(this).on('change', function() {
    ...
    return mirrorMesh.position.set(0, -(dimensions[1] / 2 * s + 4.23), 0);
  }).trigger('change');
});

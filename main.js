...
var ASPECT, FAR, HEIGHT, NEAR, VIEW_ANGLE, WIDTH, animate, camera, canvas, canvases, controls, ctx, dimensions, face, faceMaterial, i, light, map, materials, mouse, product, productGeometry, renderer, scene, skyBox, skyBoxGeometry, skyBoxMaterial, unprojector, _i, _len, _ref;
...
$("body").on("mousemove dragover dragenter drop", function(e) {
  var dt, file, fr, intersect, intersects, mid, ray, vector, _j, _len1, _ref1, _ref2, _results;
  e.preventDefault();
